...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReusableDataInput/ReusableDataInput.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Toaster/Toaster.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iOSReusableExtensions/iOSReusableExtensions.framework"
fi
